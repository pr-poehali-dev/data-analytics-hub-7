...
export const SERVICES = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Вы не оплачиваете проект полностью на старте. Основной расчет (70%) производится только после выполнения целевых показателей. Ваша финансовая безопасность гарантирована банком.",
    },
    {
      icon: "Search",
...
export const ABOUT = {
  ...
  values: [
    ...
    { title: "Банковский арбитраж", description: "Мы используем систему непокрытых аккредитивов. Защищаем вашу компанию от избыточной нагрузки до момента приемки работ" },
