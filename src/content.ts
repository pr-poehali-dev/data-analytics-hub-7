...
export const PROCESS = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "Безопасная сделка",
      description:
        "Вы вносите средства на защищенный номинальный счет. Деньги депонированы до момента верификации результата. Никаких рисков: вы платите только за подтвержденный KPI.",
    },
    {
      icon: "BarChart2",
      number: "04",
...
export const TESTIMONIALS = {
  ...
  items: [
    {
      quote:
        "**Nexus AI** помог нам внедрить AI-ассистента в отдел продаж за 6 недель. Конверсия выросла на 18%. Главное — основная сумма была защищена номинальным счетом до подтверждения результата. Никакого риска.",
      name: "Алексей К.",
    ...
    {
      quote:
        "Скептически относился к ИИ-консалтингу, пока не узнал о системе номинальных счетов **Nexus AI**. Контроль выплат через номинальный счет — это серьезно. Результат подтверждён: документооборот сократился вдвое.",
      name: "Игорь Р.",
