...
export const PROCESS = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "Безопасная сделка",
      description:
        "Вы вносите средства на защищенный номинальный счет. Деньги заморожены до момента верификации результата. Никаких рисков: вы платите только за подтвержденный KPI.",
    },
    {
      icon: "BarChart2",
      number: "04",
...
export const TESTIMONIALS = {
  ...
  items: [
    ...
    {
      quote:
        "Скептически относился к ИИ-консалтингу, пока не узнал о системе номинальных счетов **Nexus AI**. Деньги за выполнение KPI - это серьезно. Результат подтверждён: документооборот сократился вдвое.",
      name: "Игорь Р.",
