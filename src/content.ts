...
export const SERVICES = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Защита ваших интересов. Вы не оплачиваете проект полностью на старте. Основной расчет (70%) производится только после выполнения целевых показателей. Ваша финансовая безопасность гарантирована банком.",
    },
    {
      icon: "Search",
